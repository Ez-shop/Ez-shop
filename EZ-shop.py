...
def SportsGymCall():
    ...
    price_sportsgym1=Label(lf_sportsgym1,text="Price: Rs.2,000",font="arial 9 bold").grid(row=2,column=0)
    price_sportsgym2=Label(lf_sportsgym2,text="Price: Rs.990",font="arial 9 bold").grid(row=2,column=0)
    price_sportsgym3=Label(lf_sportsgym3,text="Price: Rs.750",font="arial 9 bold").grid(row=2,column=0)
    price_sportsgym4=Label(lf_sportsgym4,text="Price: Rs.450",font="arial 9 bold").grid(row=2,column=0)
    price_sportsgym5=Label(lf_sportsgym5,text="Price: Rs.1,080",font="arial 9 bold").grid(row=2,column=0)
    price_sportsgym6=Label(lf_sportsgym6,text="Price: Rs.30,990",font="arial 9 bold").grid(row=3,column=0)
    price_sportsgym7=Label(lf_sportsgym7,text="Price: Rs.1000",font="arial 9 bold").grid(row=4,column=0)
    price_sportsgym8=Label(lf_sportsgym8,text="Price: Rs.7,799",font="arial 9 bold").grid(row=3,column=0)
    price_sportsgym9=Label(lf_sportsgym9,text="Price: Rs.8,999",font="arial 9 bold").grid(row=2,column=0)
    price_sportsgym10=Label(lf_sportsgym10,text="Price: Rs.3,999",font="arial 9 bold").grid(row=2,column=0)
    def AddS1():
...
def FurnitureCall():
    ...
    price_furniture1=Label(lf_furniture1,text="Price: Rs.7,990",font="arial 9 bold").grid(row=2,column=0)
    price_furniture2=Label(lf_furniture2,text="Price: Rs.20,390",font="arial 9 bold").grid(row=3,column=0)
    price_furniture3=Label(lf_furniture3,text="Price: Rs.25,999",font="arial 9 bold").grid(row=3,column=0)
    price_furniture4=Label(lf_furniture4,text="Price: Rs.15,290",font="arial 9 bold").grid(row=4,column=0)
    price_furniture5=Label(lf_furniture5,text="Price: Rs.15,640",font="arial 9 bold").grid(row=3,column=0)
    price_furniture6=Label(lf_furniture6,text="Price: Rs.7,590",font="arial 9 bold").grid(row=2,column=0)
    price_furniture7=Label(lf_furniture7,text="Price: Rs.16,999",font="arial 9 bold").grid(row=3,column=0)
    price_furniture8=Label(lf_furniture8,text="Price: Rs.27,490",font="arial 9 bold").grid(row=3,column=0)
    price_furniture9=Label(lf_furniture9,text="Price: Rs.38,854",font="arial 9 bold").grid(row=4,column=0)
    price_furniture10=Label(lf_furniture10,text="Price: Rs.29,999",font="arial 9 bold").grid(row=3,column=0)
    def AddF1():
...
def AppliancesCall():
    ...
    price_appliances1=Label(lf_appliances1,text="Price: Rs.15,990",font="arial 9 bold").grid(row=2,column=0)
    price_appliances2=Label(lf_appliances2,text="Price: Rs.25,790",font="arial 9 bold").grid(row=2,column=0)
    price_appliances3=Label(lf_appliances3,text="Price: Rs.40,999",font="arial 9 bold").grid(row=3,column=0)
    price_appliances4=Label(lf_appliances4,text="Price: Rs.30,290",font="arial 9 bold").grid(row=2,column=0)
    price_appliances5=Label(lf_appliances5,text="Price: Rs.11,690",font="arial 9 bold").grid(row=3,column=0)
    price_appliances6=Label(lf_appliances6,text="Price: Rs.10,999",font="arial 9 bold").grid(row=2,column=0)
    price_appliances7=Label(lf_appliances7,text="Price: Rs.976",font="arial 9 bold").grid(row=2,column=0)
    price_appliances8=Label(lf_appliances8,text="Price: Rs.13,999",font="arial 9 bold").grid(row=3,column=0)
    price_appliances9=Label(lf_appliances9,text="Price: Rs.15,499",font="arial 9 bold").grid(row=2,column=0)
    price_appliances10=Label(lf_appliances10,text="Price: Rs.4,249",font="arial 9 bold").grid(row=3,column=0)
    def AddA1():
